...
@router.post("/inscripcion", response_model=inscripcion.InscripcionResponse)
async def altaIncripcion(inscripcion_data : inscripcion.InscripcionCreate, usuario = Depends(auth_deps.get_current_user)):
